...
const App = () => {
  // const listProducts = [
  //   { name: 'detergente', price: 8.5 },
  //   { name: 'amaciante', price: 29 },
  //   { name: 'palha de aço', price: 5.3 },
  //   { name: 'esponja', price: 4 },
  //   { name: 'vassoura', price: 10.7 },
  //   { name: 'desintupidor', price: 14.9 },
  //   { name: 'rodo', price: 12 },
  // ];
  ...
  return (
    ...
    // <>
    //   <h1 className="font-bold text-3xl m-4 text-center">Lista de Produtos</h1>
    ...
    //           <div className="text-2xl font-bold text-indigo-600">Meu SPA</div>
    ...
    //         <p className="text-sm">
    //           &copy; {new Date().getFullYear()} Exemplo de SPA - Desenvolvimento
    //           de Aplicações com Frameworks Web
    //         </p>
