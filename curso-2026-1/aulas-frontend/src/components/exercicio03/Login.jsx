...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!email || !senha) {
            ...
            console.log(`Enviando dados para servidor: ${email}, ${senha}}`);
            setEmail('');
            setSenha('');
        }
    }
    ...
    return (
        <div className='mx-auto my-8 w-[min(92vw,460px)] rounded-2xl border border-slate-200 bg-linear-to-b from-white to-slate-50 p-6 shadow-lg shadow-slate-900/10'>
            <h2 className='mb-4 text-center text-2xl font-bold text-slate-900'>Login de Usuário</h2>
            ...
            <div className='text-center'>
                <button onClick={() => navigate('/cadastro')} className='p-2 hover:text-blue-600 '>Não possui casdastro? Crie aqui!</button>
            </div>
